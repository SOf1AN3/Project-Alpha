...
const ExpatsServices = () => {
	...
	•	Trouver des solutions pour la continuité des études ou des programmes adaptés à leur niveau.`
          },
          {
               ...
               answer: `Votre retour peut également être une opportunité pour relancer votre carrière ou entreprendre de nouveaux projets :
	...
	•	Assistance Complète : De la préparation avant votre départ à votre installation complète, nous sommes à vos côtés à chaque étape.`
     ...
     return (
          <div className="container-qst">
               ...
               <p>Prêt à faire le grand saut et revenir en Algérie ? Contactez-nous dès aujourd’hui pour une consultation gratuite. Nous serons ravis de discuter de votre projet et de vous montrer comment nous pouvons vous aider à faire de ce retour une réussite.
